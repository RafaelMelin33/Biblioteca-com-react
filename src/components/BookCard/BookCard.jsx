    ...
    return(
        <div className={'' + css.card}>
            <div className={'rounded-3 ' + css.divImagem}>
                ...
                <div id={'botaoSobreposto'} className={'d-flex justify-content-center align-items-center rounded-3 ' + css.botaoSobreposto}><Button texto={'VER DETALHES'} tipo={'card'} /></div>
